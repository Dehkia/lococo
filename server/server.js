...
app.post("/inputdb", upload.single("SkillImage"), function (req, res) {
  ...
  connection.query(sql1, param1, function (err, rows) {
    ...
    if (rows[0] !== undefined) {
      ...
      var sql =
        "Insert INTO skill (JobName,SkillName,SkillEx,AttHit,DefHit,SkillImg,TripodName1,TripodEx1,TripodName2,TripodEx2,TripodName3,TripodEx3,TripodName4,TripodEx4,TripodName5,TripodEx5,TripodName6,TripodEx6,TripodName7,TripodEx7,TripodName8,TripodEx8) VALUES(?,?,?,?,?,?,?) ";
      ...
      const Tripod = [
        req.body.TripodName1,
        req.body.TripodEx1,
        req.body.TripodName2,
        req.body.TripodEx2,
        req.body.TripodName3,
        req.body.TripodEx3,
        req.body.TripodName4,
        req.body.TripodEx4,
        req.body.TripodName5,
        req.body.TripodEx5,
        req.body.TripodName6,
        req.body.TripodEx6,
        req.body.TripodName7,
        req.body.TripodEx7,
        req.body.TripodName8,
        req.body.TripodEx8,
      ];
...
app.post("/inputpost", function (req, res) {
  ...
  let sql =
    "insert into post (Contents,Me,You,SkillName1,SkillName2,SkillName3,SkillName4,SkillName5) values (?,?,?,?,?,?,?,?)";
  let param = [
    req.body.contents,
    req.body.me,
    req.body.you,
...
app.get("/skilldb", function (req, res, next) {
  const sql =
    "select SkillName,SkillEx,SkillImg,TripodName1,TripodEx1,TripodName2,TripodEx2,TripodName3,TripodEx3,TripodName4,TripodEx4,TripodName5,TripodEx5,TripodName6,TripodEx6,TripodName7,TripodEx7,TripodName8,TripodEx8 from skill where JobName = ? ";
  var param = jobname;
  connection.query(sql, [param], function (err, rows) {
    if (err) console.error();
    res.render("skilldb", { rows: rows });
